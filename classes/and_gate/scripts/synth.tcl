...
write_file -format verilog -hier -out porta_and_nao_mapeada.sv
...
write_sdf -context verilog atrasos_porta_and.sdf
...
write -format verilog -hierarchy -output porta_and_mapeada.sv
